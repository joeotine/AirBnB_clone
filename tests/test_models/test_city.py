#!/usr/bin/python3
"""This module defines the unittests for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    """This is the Unittests for testing instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """This is the Unittests for testing save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """This is the Unittests for testing to_dict method of the City class."""
